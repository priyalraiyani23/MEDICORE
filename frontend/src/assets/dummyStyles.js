...
export const appointmentPageStyles = {
  ...
  pageContainer: "min-h-screen font-sans bg-linear-to-br from-green-50 to-emerald-100 py-10 px-4",
...
export const certificationStyles = {
  ...
  title: "text-3xl lg:text-6xl font-sans text-gray-900 mb-4 tracking-tight",
  ...
  logoText: "mt-3 font-sans italic text-sm font-semibold text-gray-700 text-center max-w-[120px] leading-tight group-hover:text-green-700 transition-colors duration-300",
...
export const contactPageStyles = {
  // Page container
  pageContainer: "min-h-screen bg-linear-to-br from-emerald-100 via-white to-emerald-50 py-12 px-4 sm:px-6 md:px-8 lg:px-20 font-sans relative overflow-hidden",
...
export const doctorsPageStyles = {
  ...
  // Wrapper
  wrapper: "max-w-7xl mx-auto relative z-10 font-sans",
...
export const footerStyles = {
  // Main container
  footerContainer: "relative font-sans bg-linear-to-br from-emerald-50 via-green-50 to-teal-50 border-t border-emerald-200 overflow-hidden",
  ...
  companyTagline: "text-emerald-600 font-sans text-xs md:text-sm font-semibold tracking-wide mt-1",
  companyDescription: "text-emerald-700 font-sans italic mb-5 leading-relaxed text-sm md:text-base font-light",
...
export const homeDoctorsStyles = {
  ...
  title: "text-4xl md:text-5xl font-sans italic text-gray-900",
  ...
  // Card body
  cardBody: "p-3 sm:p-4 md:p-5 font-sans",
...
export const loginPageStyles = {
  // Main container
  mainContainer: "min-h-screen flex items-center justify-center bg-linear-to-br from-green-50 via-emerald-100 to-green-200 relative font-sans overflow-hidden",
...
export const navbarStyles = {
  // Main container
  navbarContainer: "fixed top-0 w-full z-50 bg-white border-b border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.05)] transition-transform duration-500",
  ...
  logoContainer: "relative group h-14 w-14 rounded-xl flex items-center justify-center",
  logoImageWrapper: "relative flex items-center justify-center overflow-hidden h-full w-full",
  logoImage: "w-full h-full object-contain mix-blend-multiply drop-shadow-sm",
  logoTextContainer: "hidden sm:flex sm:flex-col sm:justify-center items-start text-left",
  logoTitle: "text-2xl leading-none font-extrabold text-slate-800 tracking-tight",
  logoSubtitle: "mt-1 text-[0.75rem] font-semibold tracking-wider text-slate-500 uppercase",
  ...
  // Signed out buttons
  doctorAdminButton: "hidden lg:inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold text-slate-700 hover:text-white hover:bg-[#2c4761] transition-all duration-300",
  ...
  animationStyles: `
    ...
    .navbar-border {
      ...
      height: 3px;
      z-index: 51;
      background: linear-gradient(90deg, var(--color-primary-500), var(--color-primary-400), var(--color-primary-300), var(--color-primary-500));
...
export const servicePageStyles = {
  // Page container
  pageContainer: "min-h-screen py-12 px-6 lg:px-20 font-sans bg-linear-to-b from-emerald-50 to-white",
  maxWidthContainer: "max-w-6xl mx-auto",
...
export const serviceCardStyles = {
  ...
  serviceName: "text-lg md:text-sm whitespace-nowrap font-semibold font-sans text-emerald-900",
  
  // Buttons
  buttonContainer: "mt-4",
  buttonAvailable: "inline-flex items-center justify-center gap-2 px-5 py-2 w-full rounded-full bg-teal-600 text-white font-medium",
...
export const testimonialStyles = {
  ...
  // Header
  headerContainer: "max-w-6xl font-sans mx-auto text-center mb-8 sm:mb-12",
  ...
  // Column container
  columnContainer: "relative font-sans border-2 rounded-2xl overflow-hidden bg-white/60 backdrop-blur-sm",
  ...
  // Testimonial card
  testimonialCard: "bg-white font-sans rounded-xl shadow-lg p-4 sm:p-5 mb-4 transition-transform duration-300 border-l-4 w-full max-w-xl mx-auto",
...
export const serviceDetailStyles = {
  // Page container
  pageContainer: "min-h-screen font-sans bg-linear-to-br from-emerald-50 via-white to-green-50 px-4 lg:px-12 pt-20 sm:pt-12 md:pt-8 lg:pt-0",
...
export const doctorDetailStyles = {
  // Main container
  pageContainer: "min-h-screen font-sans bg-linear-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden",
  ...
  backButton: "inline-flex items-center gap-2 mt-4 px-6 py-3 bg-teal-600 text-white rounded-full hover:bg-emerald-600 transition-all",
...
export const navbarStylesDr = {
  // Main navbar
  navContainer: "fixed top-8 left-1/2 -translate-x-1/2 z-50 w-full md:max-w-2xl lg:max-w-4xl px-4 py-0 rounded-full bg-white/80 backdrop-blur-md border border-emerald-100 shadow-2xl flex items-center justify-between gap-3 font-sans transition-all duration-300 hover:shadow-emerald-200/80 hover:-translate-y-0.5",
  ...
  mobileLogoutButton: "mt-2 px-4 py-2 rounded-full text-center bg-teal-600 text-white font-semibold text-sm shadow-sm transition-transform duration-150 hover:scale-105 w-full",
...
export const listPageStyles = {
  // Main container
  pageContainer: "min-h-screen pt-20 md:pt-25 lg:pt-25 font-sans p-4 sm:p-6 bg-linear-to-br from-emerald-50 to-white",
...
export const editProfilePageStyles = {
  // Page container
  pageContainer: "min-h-screen font-sans bg-linear-to-br from-emerald-50 via-white to-emerald-50/30 p-4 sm:p-5 md:p-6",
...
export const dashboardStyles = {
  // Main container
  pageContainer: "min-h-screen font-sans pt-16 lg:pt-20 md:pt-15 p-4 sm:p-6 bg-linear-to-br from-emerald-50 to-white",
